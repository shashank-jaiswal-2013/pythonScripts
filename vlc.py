...
if __name__ == '__main__':
    ...
    if sys.argv[1:] and sys.argv[1] not in ('-h', '--help'):
        ...
        def vol_increase():
            ...
            print "EventType.MediaVolumeChanged to",player.audio_get_volume(),"%";

        def vol_decrease():
            """Decrease volume by 5 percent"""
        ...
        def toggle_mute():
            ...
            print "EventType.MediaMuteStateChanged to",bool(player.audio_get_mute());
